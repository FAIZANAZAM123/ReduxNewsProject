...
const Navbar = ({ first, setfirst }) => {
    ...
    return (
        <>
                ...
                <div className="container-fluid">
                    ...
                    <div className=" justify-content-space-evenly collapse navbar-collapse  " id="navbarSupportedContent">
                        ...
                        <form className="d-flex" role="search">
                            <input className="form-control formcon   me-2" type="search" placeholder="Search" aria-label="Search" />
            ...
            {/* <form className={` d-flex hello2 sticky-top ${first === 'dark' ?'bg-dark' : ''}`} style={first === 'dark' ?' ' :{
                background: 'linear-gradient(to right, #667eea, #764ba2)'
            }} role="search">
            <input className={`${first==='light'?'btn-outline-primary' :''} form-control formcontrol1   me-2`} type="search" placeholder="Search" aria-label="Search" /> */}


            {/* <input style={{ paddingLeft: "10px" }} className={`${first==='light'?'btn-outline-primary' :''} form-control formcontrol1   me-2`} type="search" placeholder=" Search"aria-label="Search" /> */}
